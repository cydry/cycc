...
assert 2 'int main(){int a[10]; int* p; p=a;   a=2; *p;}'
assert 2 'int main(){int a[10]; int* p; p=a+1; a=2; p=p-1; *p;}'
assert 3 'int main(){int a[10]; int* p; p=a+2; a=3; p=p-2; *p;}'
assert 5 'int main(){int a[10]; int* p; p=a+9; a=5; p=p-9; *p;}'

assert 2 'int main(){int a[10]; int* p; p=a;   *p=2; *a;}'
assert 3 'int main(){int a[10]; int* p; p=a+1; *p=3; *(a+1);}'
assert 5 'int main(){int a[10]; int* p; p=a+2; *p=5; *(a+2);}'
assert 7 'int main(){int a[10]; int* p; p=a+9; *p=7; *(a+9);}'

assert 2 'int main(){int a[10]; int* p; p=a;   *p=2; *(a-1+1);}'
assert 3 'int main(){int a[10]; int* p; p=a+1; *p=3; *(a-2+3);}'
assert 5 'int main(){int a[10]; int* p; p=a+2; *p=5; *(a-3+5);}'
assert 7 'int main(){int a[10]; int* p; p=a+9; *p=7; *(a-9+18);}'

assert 2 'int main(){int a[10]; int* p; p=a;   *p=2; a[0];}'
assert 3 'int main(){int a[10]; int* p; p=a+1; *p=3; a[1];}'
assert 5 'int main(){int a[10]; int* p; p=a+2; *p=5; a[2];}'
assert 7 'int main(){int a[10]; int* p; p=a+9; *p=7; a[9];}'
